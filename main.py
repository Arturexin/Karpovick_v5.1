...
app.register_blueprint(entradas_.entradas_post)
...
app.register_blueprint(salidas_.salidas_suma_total_mes)
app.register_blueprint(salidas_.salidas_suma_total_pasado)
...
app.register_blueprint(salidas_.salidas_individual_id)
app.register_blueprint(salidas_.salidas_categoria_kardex)
app.register_blueprint(salidas_.salidas_suc_kardex)
...
app.register_blueprint(ventas_.ventas_conteo_frecuencia)
app.register_blueprint(ventas_.ventas_conteo_montos)
